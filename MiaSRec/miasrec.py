...
class TransNet(nn.Module):
    def __init__(self, config):
        ...
        self.position_embedding = nn.Embedding(config['seqlen']+1, self.hidden_size) # 0 for mean pooling
